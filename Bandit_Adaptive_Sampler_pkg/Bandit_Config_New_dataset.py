...
def get_bandit_sampler_config():
    ...
    parser.add_argument('--g_pool_step_meta', default=500, type=int, help='pooling step for meta-model')
    parser.add_argument('--g_pool_step_bandit', default=300, type=int, help='pooling step for bandit sampler')

    parser.add_argument('--buffer_size', default=500, type=int, help='buffer size for received records')
